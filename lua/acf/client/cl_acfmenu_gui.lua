...
--[[=========================
	...
	------------------- ACE2 information folder -------------------


	HomeNode = TreePanel:AddNode( "ACE2 Main Menu" , MainMenuIcon ) --Main Menu folder
...
http.Fetch("http://raw.github.com/CosmicStar98/ArmoredCombatEnhanced/master/changelog.txt", ACFChangelogHTTPCallBack, function() end)
...
function ACFCLGUICreate()
	...
	Client:SetText("ACE2 - Client Side Control Panel")
...
function ACFSVGUICreate()	--Serverside folder content
	...
	Server:SetText("ACE2 - Server Side Control Panel")
...
function ContactGUICreate()
	...
	acfmenupanel:CPanelText("desc1","If you want to contribute to ACE2 by providing us feedback, report bugs or tell us suggestions about new stuff to be added, our discord is a good place.")
	...
	gui.OpenURL("https://discord.gg/s3ejVEKpnB")
	end
