...
local introTxt			= "Damage Permission Modes change the way that ACE2 damage works.\n\nYou can change the DP mode if you are an admin."

local statusTxt		= "\nCurrent Protection status:"
local condition		= "Unknown"

local cppidl			= "Do you need ACE2 protection? Remember to restart your game once installed!"
