timer.Simple(1, function()
    ...
    function CPPI:GetName() return "CPPI for ACE2" end
    function CPPI:GetVersion() return "ACE2" end
    ...
    MsgC(Color(255, 0, 0), "[ACE2 Warning] ", Color(255, 255, 255), "Couldn't find a CPPI-compliant prop protection addon, using fallback methods.\n")
