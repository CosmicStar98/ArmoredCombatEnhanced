...
-- @class library
-- @libtbl acf_library
-- @src https://github.com/CosmicStar98/ArmoredCombatEnhanced/tree/master/lua/starfall/lib_sv/acf.lua
...
local function getLinks(ent, enttype)
	...
	for entry, mode in pairs(linkTables[enttype]) do
		if not ent[entry] then
			SF.Throw("[Internal ACE2 Error] Couldn't find link resource " .. entry .. " for entity " .. tostring(ent), 2)
