...
ACFTranslation.ACFMenuTool = {
	...
	"ACE2 Menu", -- Tool Name (1)
	"Armored Combat Enhanced", -- ACE2 Modification Text (2)
	"Spawn the Armored Combat Enhanced weapons and ammo", -- Description 1 (3)
	...
	"Undone ACE2 Entity",-- Undo entity (6)
	"Undone ACE2 Engine",--Undo Engine (7)
	"Undone ACE2 Gearbox",--Undo Gearbox (8)
	"Undone ACE2 Ammo",--Undo Ammo (9)
	"Undone ACE2 Gun",--Undo Gun (10)
	"You've reached the ACE2 Guns limit!",--Gun limit (11)
	"You've reached the ACE2 Launchers limit!",--Launcher Limit (12)
	"You've reached the ACE2 Explosives limit!",--Explosive Limit (13)
	"You've reached the ACE2 Sensors limit!",--Sensor Limit (14)
...
ACFTranslation.ACFCuttingTorch = {
	...
	"ACE2 Cutting torch", --Tool Name (1)
